...
$kullanicisor->execute(array(
    'kullanici_id' => $_GET['kullanici_id'] // kullanıcı listesinden get ile aldık bu kullanıcı idyi.
));
$kullanicicek = $kullanicisor->fetch(PDO::FETCH_ASSOC);

$kullanicifirmasor = $db->prepare("SELECT * FROM firma where kullanici_id=:kullanici_id");
$kullanicifirmasor->execute(array(
    "kullanici_id" => $_GET['kullanici_id']
));
$kullanicifirmacek = $kullanicifirmasor->fetch(PDO::FETCH_ASSOC);

$kullanicibankasor = $db->prepare("SELECT * FROM banka where kullanici_id=:kullanici_id");
    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Kullanıcı Onay Düzenleme <small>
                                <?php
                                ...
                                <?php } else if (isset($_GET['durum']) and $_GET['durum'] == "no") { ?>
                    ...
                    <div class="x_content">
                        ...
                        <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="tel" disabled=""
                                            value="<?php echo $kullanicibankacek['banka_ad'] ?>" required="required"
                                            minlength="14" maxlength="14"
                                            class="form-control col-md-7 col-xs-12">
                                    </div>
                            </div>              
                            ...
                            <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> IBAN
                                    <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="tel" disabled=""
                                            value="<?php echo  $kullanicibankacek['banka_iban'] ?>" required="required"
                                            minlength="14" maxlength="14"
                                            class="form-control col-md-7 col-xs-12">
                                    </div>
                            </div>
                            ...
                            <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> Hesap Ad Soyad
                                    <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="tel" disabled=""
                                            value="<?php echo  $kullanicibankacek['banka_hesapadsoyad'] ?>" required="required"
                                            minlength="14" maxlength="14"
                                            class="form-control col-md-7 col-xs-12">
                                    </div>
                            </div>  
                            ...
                            <div class="form-group">
                                <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                        <button type="submit" name="kullanici_basvuru_onay"
                                        class="btn btn-success">Başvuruyu Onayla</button>


                                        <a  class="btn btn-danger" onclick=" return confirm('Kullanıcının Teklif & Talep başvurusunu iptal etmek istiyor musunuz?') " href="../netting/islem.php?kullanici_onay=red&kullanici_id=<?php echo $kullanicicek["kullanici_id"]; ?>">
                                            Başvuruyu İptal Et
                                        </a>
