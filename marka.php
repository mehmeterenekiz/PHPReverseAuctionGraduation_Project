...
if (isset($_GET['marka_id'])) {
    ...
    $talepsor = $db->prepare("SELECT * FROM talep inner join vasitamarka on talep.talep_marka = vasitamarka.marka_id where talep_durum=:talep_durum and talep.talep_marka=:talep_marka order by talep_zaman desc limit $limit,$sayfada");
    ...
    <div class="container">
        <div class="pagination-wrapper" style=" margin-top: -1rem; margin-bottom: -5rem;">
            <ul>
                ...
                <li><a href="kategori-vasita-14">vasıta</a><span> -</span></li>
                <?php
                $talep_marka = $_GET['marka_id'];
                $markasor = $db->prepare("SELECT * FROM vasitamarka where marka_id=:marka_id");
                $markasor->execute(array(
                    'marka_id' => $talep_marka,
                ));
                $markacek = $markasor->fetch(PDO::FETCH_ASSOC)
                    ?>
                <li> <?php echo $markacek['marka_ad'] ?> </li>
                ...
                <div class="inner-page-main-body">
                                ...
                                <div class="page-controls-sorting">
                                    <div class="dropdown-sorting">
                                        ...
                                        <div class="dropdown-sorting-content" id="dropdown-sorting-menu"
                                            data-marka-seo="<?php echo seo($markacek['marka_ad']) ?>"
                                            data-marka-id="<?php echo $_GET['marka_id']; ?>">
                    ...
                    <script>
                        $("#dropdown-sorting-menu div").on("click", function () {
                            ...
                            var markaId = $("#dropdown-sorting-menu").data("marka-id");
                            var markaSeo = $("#dropdown-sorting-menu").data("marka-seo");
                            ...
                            $.ajax({
                                url: "../../nedmin/netting/ilan-filtre-api.php?marka_id=" + markaId + "&marka_seo=" + markaSeo + "&sayfa=1",
                                type: "POST",
                                data: { sort: sort },
                        ...
                        $(document).on("click", ".pagination-link", function (e) {
                            ...
                            $.ajax({
                                url: "../../nedmin/netting/ilan-filtre-api.php?marka_id=" + markaId + "&marka_seo=" + markaSeo + "&sayfa=" + sayfa,
                                type: "POST",
                                data: { sort: sort },
                                success: function (response) {
                                    $("#ilanlar-alani").html(response);
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <ul class="pagination-align-left">
                                                ...
                                                for ($s = 1; $s <= $toplam_sayfa; $s++) {
                                                    ...
                                                    if (!empty($_GET['marka_id'])) {
                                                        $url = "marka-{$_GET['sef']}-{$_GET['marka_id']}?sayfa=$s";
                                                    } else {
                                                        $url = "marka?sayfa=$s";
                                                    }
