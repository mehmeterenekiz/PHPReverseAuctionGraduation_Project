                ...
                <form action="nedmin/netting/kullanici-islem.php" method="POST" class="form-horizontal"
                    ...
                    <div class="settings-details tab-content">
                        <div class="tab-pane fade active in" id="Talep">
                            <h2 class="title-section">Talep Oluştur</h2>
                            ...
                            <div class="personal-info inner-page-padding">
                                    ...
                                    <div class="dropdown" style="margin-left: 3.1rem !important; margin-top: 1.2rem;">
                                        <select name="talep_marka" style="width: 171.5px;">
                                            ...
                                            while ($markacek = $markasor->fetch(PDO::FETCH_ASSOC)) { ?>
                                                ...
                                                <option value="<?php echo $markacek['marka_id'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input class="form-control" type="text" id="talep_min_yil" required
                                    ...
                                    <div class="col-sm-3">
                                        <input class="form-control" type="text" id="talep_max_yil" required
                                ...
                                <div class="form-group" id="yakit_tipi">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="filter-container">
                                            <label>
                                                <input type="checkbox" name="yakit[]" value="Benzin">
                                                <span>Benzin</span>
                                            </label>
                                            <label>
                                            ...
                                            <label>
                                                <input type="checkbox" name="yakit[]" value="Dizel">
                                                <span>Dizel</span>
                                            </label>
                                            <label>
                                                <input type="checkbox" name="yakit[]" value="Hybrid">
                                                <span>Hybrid</span>
                                            </label>
                                            <label>
                                                <input type="checkbox" name="yakit[]" value="Elektrik">
                                                <span>Elektrik</span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group" id="kasa_tipi">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="filter-container">
                                            <label>
                                                <input type="checkbox" name="kasa[]" value="Cabrio">
                                                <span>Cabrio</span>
                                            </label>
                                            <label>
                                                <input type="checkbox" name="kasa[]" value="Coupe">
                                                <span>Coupe</span>
                                            </label>
                                            <label>
                                                <input type="checkbox" name="kasa[]" value="Hatchback">
                                                <span>Hatchback</span>
                                            </label>
                                            <label>
                                                <input type="checkbox" name="kasa[]" value="Sedan">
                                                <span>Sedan</span>
                                            </label>
                                            <label>
                                                <input type="checkbox" name="kasa[]" value="SUV">
                                                <span>SUV</span>
                                            </label>
                                            <label>
                                                <input type="checkbox" name="kasa[]" value="MPV">
                                                <span>MPV</span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group" id="kapi_sayisi">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="filter-container">
                                            <label>
                                                <input type="checkbox" name="kapi[]" value="3">
                                                <span>3</span>
                                            </label>
                                            <label>
                                                <input type="checkbox" name="kapi[]" value="4">
                                                <span>4</span>
                                            </label>
                                            <label>
                                                <input type="checkbox" name="kapi[]" value="5">
                                                <span>5</span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group" id="vites_tipi">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="filter-container" style="width:76.5%; ">
                                            <label>
                                                <input type="checkbox" name="vites[]" value="Manuel">
                                                <span>Manuel</span>
                                            </label>
                                            <label>
                                                <input type="checkbox" name="vites[]" value="Otomatik">
                                                <span>Otomatik</span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="col-sm-1 control-label">----</label>
                                    <div class="col-sm-3">
                                        <input class="form-control rakam" type="text" id="talep_max_km" required
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input class="form-control rakam" type="text" id="talep_fiyat" required
                                    ...
                                    <div class="col-sm-6" style="margin-top: 0.5rem;">
                                        <label>
                                            <input type="checkbox" name="talep_uzeri_teklif" value="1"
                                ...
                                <div class="controls">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input class="form-control" type="text" id="city-input" required
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Daire Yarıçapı</label>
                                        <div class="col-sm-9">
                                            <input type="range" id="radius-slider" name="talep_cember_yaricap"
                                                min="70000" max="800000" step="100" value="70000">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12" style="text-align: right; position:">
                                            <button type="submit" name="talep_olustur" class="update-btn"
                                                id="login-update">
                                                Talep Oluştur
                                            </button>
                                        </div>
...
<script>
    ...
    function initMap() {
        ...
        const initialLocation = { lat: 39.92077, lng: 32.85411 }; // Ankara
        ...
        circle = new google.maps.Circle({
            map: map,
            radius: 70000, // Varsayılan yarıçap (70km)
